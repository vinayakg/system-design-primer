...
[任何貢獻](readme-zh-tw.md#如何貢獻) 都相當歡迎！
...
* [學習指南](readme-zh-tw.md#學習指南)
* [如何解決一個系統設計的面試題目](readme-zh-tw.md#如何解決一個系統設計的面試題目)
* [系統設計面試問題與**解答**](readme-zh-tw.md#系統設計面試問題與解答)
* [物件導向設計問題與**解答**](readme-zh-tw.md#物件導向設計面試問題與解答)
* [其他的系統設計面試問題](readme-zh-tw.md#其他的系統設計面試問題)
...
* [系統設計單字卡](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/resources/flash_cards/System%20Design.apkg)
* [系統設計練習單字卡](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/resources/flash_cards/System%20Design%20Exercises.apkg)
* [物件導向設計練習單字卡](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/resources/flash_cards/OO%20Design.apkg)
...
某些還需要再完善的章節放在 [修正中](readme-zh-tw.md#仍在進行中)。
...
* [系統設計主題：從這裡開始](readme-zh-tw.md#系統設計主題從這裡開始)
  * [第一步：複習關於可擴展性的影片講座](readme-zh-tw.md#第一步複習關於可擴展性的影片講座)
  * [第二步：複習關於可擴展性的文章](readme-zh-tw.md#第二步複習關於可擴展性的文章)
  * [下一步](readme-zh-tw.md#下一步)
* [效能與可擴展性](readme-zh-tw.md#效能與可擴展性)
* [延遲與吞吐量](readme-zh-tw.md#延遲與吞吐量)
* [可用性與一致性](readme-zh-tw.md#可用性與一致性)
  * [CAP 理論](readme-zh-tw.md#cap-理論)
    * [CP-一致性與部分容錯性](readme-zh-tw.md#cp-一致性與部分容錯性)
    * [AP-可用性與部分容錯性](readme-zh-tw.md#ap-可用性與部分容錯性)
* [一致性模式](readme-zh-tw.md#一致性模式)
  * [弱一致性](readme-zh-tw.md#弱一致性)
  * [最終一致性](readme-zh-tw.md#最終一致性)
  * [強一致性](readme-zh-tw.md#強一致性)
* [可用性模式](readme-zh-tw.md#可用性模式)
  * [容錯轉移](readme-zh-tw.md#容錯轉移)
  * [複寫機制](readme-zh-tw.md#複寫機制)
* [域名系統](readme-zh-tw.md#域名系統)
* [內容傳遞網路\(CDN\)](readme-zh-tw.md#內容傳遞網路cdn)
  * [推送式 CDNs](readme-zh-tw.md#推送式-cdns)
  * [拉取式 CDNs](readme-zh-tw.md#拉取式-cdns)
* [負載平衡器](readme-zh-tw.md#負載平衡器)
  * [主動到備用切換模式\(AP Mode\)](readme-zh-tw.md#主動到備用切換模式ap-mode)
  * [雙主動切換模式\(AA Mode\)](readme-zh-tw.md#雙主動切換模式aa-mode)
  * [第四層負載平衡](readme-zh-tw.md#第四層負載平衡)
  * [第七層負載平衡](readme-zh-tw.md#第七層負載平衡)
  * [水平擴展](readme-zh-tw.md#水平擴展)
* [反向代理\(網頁伺服器\)](readme-zh-tw.md#反向代理網頁伺服器)
  * [負載平衡器與反向代理伺服器](readme-zh-tw.md#負載平衡器與反向代理伺服器)
* [應用層](readme-zh-tw.md#應用層)
  * [微服務](readme-zh-tw.md#微服務)
  * [服務發現](readme-zh-tw.md#服務發現)
* [資料庫](readme-zh-tw.md#資料庫)
  * [關連式資料庫管理系統\(RDBMS\)](readme-zh-tw.md#關連式資料庫管理系統rdbms)
    * [主從複寫](readme-zh-tw.md#主從複寫)
    * [主動模式複寫](readme-zh-tw.md#主動模式複寫)
    * [聯邦式資料庫](readme-zh-tw.md#聯邦式資料庫)
    * [分片](readme-zh-tw.md#分片)
    * [反正規化](readme-zh-tw.md#反正規化)
    * [SQL 優化](readme-zh-tw.md#sql-優化)
  * [NoSQL](readme-zh-tw.md#nosql)
    * [鍵-值對的資料庫](readme-zh-tw.md#鍵-值對的資料庫)
    * [文件類型資料庫](readme-zh-tw.md#文件類型資料庫)
    * [列儲存型資料庫](readme-zh-tw.md#列儲存型資料庫)
    * [圖形資料庫](readme-zh-tw.md#圖形資料庫)
  * [SQL 或 NoSQL](readme-zh-tw.md#sql-或-nosql)
* [快取](readme-zh-tw.md#快取)
  * [客戶端快取](readme-zh-tw.md#客戶端快取)
  * [CDN 快取](readme-zh-tw.md#cdn-快取)
  * [網站伺服器快取](readme-zh-tw.md#網站伺服器快取)
  * [資料庫快取](readme-zh-tw.md#資料庫快取)
  * [應用程式快取](readme-zh-tw.md#應用程式快取)
  * [資料庫查詢級別的快取](readme-zh-tw.md#資料庫查詢級別的快取)
  * [物件級別的快取](readme-zh-tw.md#物件級別的快取)
  * [什麼時候要更新快取](readme-zh-tw.md#什麼時候要更新快取)
    * [快取模式](readme-zh-tw.md#快取模式)
    * [寫入模式](readme-zh-tw.md#寫入模式)
    * [事後寫入\(回寫\)](readme-zh-tw.md#事後寫入回寫)
    * [更新式快取](readme-zh-tw.md#更新式快取)
* [非同步機制](readme-zh-tw.md#非同步機制)
  * [訊息佇列](readme-zh-tw.md#訊息佇列)
  * [工作佇列](readme-zh-tw.md#工作佇列)
  * [背壓機制](readme-zh-tw.md#背壓機制)
* [通訊](readme-zh-tw.md#通訊)
  * [傳輸控制通訊協定\(TCP\)](readme-zh-tw.md#傳輸控制通訊協定tcp)
  * [使用者資料流通訊協定 \(UDP\)](readme-zh-tw.md#使用者資料流通訊協定-udp)
  * [遠端程式呼叫 \(RPC\)](readme-zh-tw.md#遠端程式呼叫-rpc)
  * [具象狀態轉移 \(REST\)](readme-zh-tw.md#具象狀態轉移-rest)
* [資訊安全](readme-zh-tw.md#資訊安全)
* [附錄](readme-zh-tw.md#附錄)
  * [2 的次方表](readme-zh-tw.md#2-的次方表)
  * [每個開發者都應該知道的延遲數量級](readme-zh-tw.md#每個開發者都應該知道的延遲數量級)
  * [其他的系統設計面試問題](readme-zh-tw.md#其他的系統設計面試問題)
  * [真實世界的架構](readme-zh-tw.md#真實世界的架構)
  * [公司的系統架構](readme-zh-tw.md#公司的系統架構)
  * [公司的工程部落格](readme-zh-tw.md#公司的工程部落格)
* [仍在進行中](readme-zh-tw.md#仍在進行中)
* [致謝](readme-zh-tw.md#致謝)
* [聯絡資訊](readme-zh-tw.md#聯絡資訊)
* [授權](readme-zh-tw.md#授權)
...
|  | 短期 | 中期 | 長期 |
| :--- | :--- | :--- | :--- |
| 閱讀 [系統設計主題的索引](readme-zh-tw.md#系統設計主題的索引) 來取得關於系統如何運作的廣泛知識 | :+1: | :+1: | :+1: |
| 閱讀一些你要面試的 [公司的工程部落格](readme-zh-tw.md#公司的工程部落格) 文章 | :+1: | :+1: | :+1: |
| 閱讀關於 [真實世界的架構](readme-zh-tw.md#真實世界的架構) | :+1: | :+1: | :+1: |
| 複習 [如何解決一個系統設計的面試題目](readme-zh-tw.md#如何解決一個系統設計的面試題目) | :+1: | :+1: | :+1: |
| 完成 [系統設計面試題目與解答](readme-zh-tw.md#系統設計面試問題與解答) | 一些 | 很多 | 大部分 |
| 完成 [物件導向設計與解答](readme-zh-tw.md#物件導向設計面試問題與解答) | 一些 | 很多 | 大部分 |
| 複習 [其他的系統設計面試問題](readme-zh-tw.md#其他的系統設計面試問題) | 一些 | 很多 | 大部分 |
...
你可以使用下面的步驟來引導整個討論過程。為了鞏固這個流程，請使用下面的步驟完成 [系統設計面試題目與解答](readme-zh-tw.md#系統設計面試問題與解答) 這個章節。
...
對每一個核心元件進行深入的分析。舉例來說， 如果你被問到 [設計一個短網址的服務](solutions/system_design/pastebin/) ，可以開始討論以下內容：
...
針對你的設計討論可能的解決方法與代價。每個設計都有取捨。使用 [可擴展的設計原則](readme-zh-tw.md#系統設計主題：從這裡開始) 來處理系統瓶頸。

#### 快速有效的進行估算

你可能被要求針對你的設計進行一些估算，可以參考 [附錄](readme-zh-tw.md#附錄) 的一些資源：
...
| 問題 |  |
| :--- | :--- |
| 設計 Pastebin.com \(或 Bit.ly\) | [解答](solutions/system_design/pastebin/) |
| 設計一個像是 Twitter 的 timeline \(或 Facebook feed\)設計一個 Twitter 搜尋功能 \(or Facebook 搜尋功能\) | [解答](solutions/system_design/twitter/) |
| 設計一個爬蟲系統 | [解答](solutions/system_design/web_crawler/) |
| 設計 Mint.com 網站 | [解答](solutions/system_design/mint/) |
| 設計一個社交網站的資料結構 | [解答](solutions/system_design/social_graph/) |
| 設計一個搜尋引擎使用的鍵值儲存資料結構 | [解答](solutions/system_design/query_cache/) |
| 設計一個根據產品分類的亞馬遜銷售排名 | [解答](solutions/system_design/sales_rank/) |
| 在 AWS 上設計一個百萬用戶等級的系統 | [解答](solutions/system_design/scaling_aws/) |
| 增加一個系統設計的問題 | [貢獻](readme-zh-tw.md#如何貢獻) |

#### 設計 Pastebin.com \(或 Bit.ly\)

[閱讀練習與解答](solutions/system_design/pastebin/)

![Imgur](http://i.imgur.com/4edXG0T.png)

#### 設計一個像是 Twitter 的 timeline \(或 Facebook feed\)設計一個 Twitter 搜尋功能 \(or Facebook 搜尋功能\)

[閱讀練習與解答](solutions/system_design/twitter/)

![Imgur](http://i.imgur.com/jrUBAF7.png)

#### 設計一個爬蟲系統

[閱讀練習與解答](solutions/system_design/web_crawler/)

![Imgur](http://i.imgur.com/bWxPtQA.png)

#### 設計 Mint.com 網站

[閱讀練習與解答](solutions/system_design/mint/)

![Imgur](http://i.imgur.com/V5q57vU.png)

#### 設計一個社交網站的資料結構

[閱讀練習與解答](solutions/system_design/social_graph/)

![Imgur](http://i.imgur.com/cdCv5g7.png)

#### 設計一個搜尋引擎使用的鍵值儲存資料結構

[閱讀練習與解答](solutions/system_design/query_cache/)

![Imgur](http://i.imgur.com/4j99mhe.png)

#### 設計一個根據產品分類的亞馬遜銷售排名

[閱讀練習與解答](solutions/system_design/sales_rank/)

![Imgur](http://i.imgur.com/MzExP06.png)

#### 在 AWS 上設計一個百萬用戶等級的系統

[閱讀練習與解答](solutions/system_design/scaling_aws/)
...
| 問題 |  |
| :--- | :--- |
| 設計一個 hash map | [解答](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/solutions/object_oriented_design/hash_table/hash_map.ipynb) |
| 設計一個 LRU 快取 | [解答](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/solutions/object_oriented_design/lru_cache/lru_cache.ipynb) |
| 設計一個客服系統 | [解答](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/solutions/object_oriented_design/call_center/call_center.ipynb) |
| 設計一副牌 | [解答](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/solutions/object_oriented_design/deck_of_cards/deck_of_cards.ipynb) |
| 設計一個停車場 | [解答](https://github.com/vinayakg/system-design-primer/tree/449dc27f33991fe558a83c6815eb28ae294428dd/solutions/object_oriented_design/online_chat/online_chat.ipynb) |
| 設計一個環形陣列 | [如何貢獻](readme-zh-tw.md#如何貢獻) |
| 增加一個物件導向設計問題 | [如何貢獻](readme-zh-tw.md#如何貢獻) |
...
如果服務**性能**的增加和資源的投入是成正比時，代表服務是可擴展的。一般來說，增加性能代表服務更多的工作單元，也可以處理更多的資料。[1](http://www.allthingsdistributed.com/2006/03/a_word_on_scalability.html)
...
#### CAP 理論
 ...
 [來源：再看 CAP 理論](http://robertgreiner.com/2014/08/cap-theorem-revisited)
...
_網路是不可靠的，你的設計必須要確保部分容錯性，所以你只能夠在一致性與可用性中做出取捨。_
...
當你的系統需求需要保證 [最終一致性](readme-zh-tw.md#最終一致性) ，或當外部系統故障時，系統要能夠繼續運作時，AP 是一個不錯的選擇。
...
當你的資料有多個副本時，要考慮怎麼同步他們，以便讓使用者有一致的資料顯示。想想 [CAP 理論](readme-zh-tw.md#cap-理論) 中的一致性定律 - 每次的訪問都可以得到最新的資料，但可能也會收到錯誤的回應。
...
這一個主題進一步討論了 [資料庫](readme-zh-tw.md#資料庫) 部分：

* [主動到備用複寫](readme-zh-tw.md#主動到備用複寫)
* [雙主動複寫](readme-zh-tw.md#雙主動複寫)

### 域名系統

 ![](http://i.imgur.com/IOyLj4i.jpg)  
 [資料來源：DNS 安全介紹](http://www.slideshare.net/srikrupa5/dns-security-presentation-issa)
...
* \[DNS 架構\]\([https://technet.microsoft.com/en-us/library/dd197427\(v=ws.10\).aspx](https://technet.microsoft.com/en-us/library/dd197427%28v=ws.10%29.aspx)\)
...
### 內容傳遞網路\(CDN\)
 ...
 [來源：為什麼要使用 CDN](https://www.creative-artworks.eu/why-use-a-content-delivery-network-cdn/)
...
### 負載平衡器
 ...
 [來源：可擴展的系統設計模式](http://horicky.blogspot.com/2010/10/scalable-system-design-patterns.html)
...
第四層的負載平衡器會監看 [傳輸層](readme-zh-tw.md#傳輸層) 的資訊來決定如何分發請求。一般來說，這包含了來源、目標 IP 位置，以及在 header 中的 port，但不包含資料本身的內容。第四層的負載平衡器會透過 [網路地址轉換\(NAT\)](https://www.nginx.com/resources/glossary/layer-4-load-balancing/) 來向上游的伺服器轉發資料。

#### 第七層負載平衡

第七層的負載平衡器會監看 [應用層](readme-zh-tw.md#應用層) 來決定如何分發請求。這包含了請求的 header、訊息和 cookies。這種負載平衡器會終結網路的流量、讀取訊息並做出如何轉發訊息的決定，並把流量轉往對應的伺服器。舉例來說，一個第七層的負載平衡器可以將影音的流量轉往負責影音流量的伺服器，而將更敏感的使用者帳單的請求轉往安全性更強的伺服器。
...
* 水平擴展會增加複雜性，同時也涉及了多台伺服器的議題
  ...
  * Session 可以集中儲存在資料庫或 [快取](readme-zh-tw.md#快取)\(Redis、Memcached\) 等資料儲存中。
...
* \[維基百科\]\([https://en.wikipedia.org/wiki/Load\_balancing\_\(computing](https://en.wikipedia.org/wiki/Load_balancing_%28computing)\)\)
...
### 反向代理\(網頁伺服器\)
 ...
 [來源：維基百科](https://upload.wikimedia.org/wikipedia/commons/6/67/Reverse_proxy_h2g2bob.svg)  
...
### 應用層
 ...
 [資料來源：可縮放式系統架構介紹](http://lethain.com/introduction-to-architecting-systems-for-scale/#platform_layer)
...
在應用層中的工作程式可以實作 [非同步機制](readme-zh-tw.md#非同步機制)

#### 微服務

相關的主題還有 [微服務](https://en.wikipedia.org/wiki/Microservices) ，指的是可以獨立運作、小型的模組化服務。每個服務會透過明確定義好的輕量級溝通機制，運作在一個獨立的流程中來共同實現一個目標。[1](https://smartbear.com/learn/api-design/what-are-microservices)

舉例來說，Pinterest 可能有以下這些微服務：使用者資料、跟隨者、Feed、搜尋、照片上傳等等。

#### 服務發現

[Consul](https://www.consul.io/docs/index.html)、[Etcd](https://coreos.com/etcd/docs/latest), 或是 [Zookeeper](http://www.slideshare.net/sauravhaloi/introduction-to-apache-zookeeper) 等系統可以透過註冊的名稱、位置、Port 等資訊來幫助各個服務發現彼此。[Health checks](https://www.consul.io/intro/getting-started/checks.html) 可以幫助確認服務的完整性以及是否經常使用一個 [HTTP](readme-zh-tw.md#hypertext-transfer-protocol-http) 的路徑。[鍵-值對的資料庫](readme-zh-tw.md#鍵-值對的資料庫) 則用來儲存設定的資訊與其他共享的資料。
...
主資料庫負責讀和寫，並且將寫入的資料複寫至一或多個從屬資料庫中，從屬資料庫只負責讀取。而從屬資料庫可以再將寫入複製到更多以樹狀結構的其他資料庫中。如果主資料庫離線了，系統可以以只讀模式運行，直到某個從屬資料庫被提升為主資料庫，或有新的主資料庫出現。
 ...
 [來源： 可擴展性、可用性、穩定性及其模式](http://www.slideshare.net/jboner/scalability-availability-stability-patterns/)

**主從複寫的缺點**

* 需要額外的處理邏輯來將從屬資料庫提升為主要資料庫。
* 參考 [複寫的缺點](readme-zh-tw.md#複寫的缺點) 章節，你可以看到主動模式複寫與主從模式**共同**的缺點。
...
類似於 [聯邦式資料庫](readme-zh-tw.md#聯邦式資料庫) 的優點，分片可以減少讀取和寫入的流量、減少複製並提高快取命中率。索引的容量也會減少，如此一來可以改善查詢的效能。當一個分片出現問題時，其餘的仍然可以正常運作，而為了避免資料遺失，你可能需要思考其他複寫的機制。如同聯邦式資料庫，分片的機制並沒有中央式的資料庫，你可以並行寫入以增加吞吐量。
...
* \[分片資料庫架構\]\([https://en.wikipedia.org/wiki/Shard\_\(database\_architecture](https://en.wikipedia.org/wiki/Shard_%28database_architecture)\)\)
...
一旦資料使用如 [聯合](readme-zh-tw.md#聯合) 或 [切片](readme-zh-tw.md#切片) 等技術被分割，處理跨資料中心 Join 操作的複雜度。反正規化可以避免這種複雜的操作。
...
* 有性能需求時，可以進行 [反正規化](readme-zh-tw.md#反正規化)。
...
NoSQL 指的是 **鍵-值對的資料庫**、**文件類型資料庫**、**列儲存型資料庫** 和 **圖形資料庫** 等的統稱。資料是非正規化的，Join 大部分在應用端完成。大多數的 NoSQL 資料庫無法真正實現 ACID 的 transaction，他們通常會支援 [最終一致性](readme-zh-tw.md#最終一致性)。

**BASE** 通常被用來描述 NoSQL 資料庫的特性。 跟 [CAP 理論](readme-zh-tw.md#cap%20理論) 相比，BASE 強調可用性而非一致性。

* **基本可用** - 系統保證可用性。
* **軟狀態** - 系統的狀態可能隨著時間改變，即使在沒有輸入的情況下也是如此。
* **最終一致性** - 經過一段時間之後，在沒有收到任何輸入的情況下，系統最終會達到一致。

除了在 [SQL 或 NoSQL](readme-zh-tw.md#sql-或-nosql) 之間做選擇，了解哪種類型的 NoSQL 資料庫最適合你的需求也是很有幫助的。我們會在下一節中快速瞭解一下 **鍵-值對的資料庫**、**文件類型資料庫**、**列儲存型資料庫** 和 **圖形資料庫** 等資料庫。
...
**列儲存型資料庫**
 ...
 [來源：SQL 和 NoSQL，簡短的歷史介紹](http://blog.grio.com/2015/11/sql-nosql-a-brief-history.html)
...
**圖形資料庫**
 ...
 [來源： 圖形化資料庫](https://en.wikipedia.org/wiki/File:GraphDatabase_PropertyGraph.png)

> 抽象模型：圖

在圖形資料庫中，每一個節點會對應一條紀錄，而每個邊描述兩個節點之間的關係。圖形資料庫針對表示外來鍵\(Foreign Key\)眾多的複雜關聯或多對多關聯進行優化。

圖形資料庫為了儲存複雜的資料結構，例如社群網路，提供了很高的性能。他們相對較新，尚未被廣泛使用，查詢工具或資源比較難取得，許多這種類型的資料庫只能透過 [REST API](readme-zh-tw.md#representational-state-transfer-rest) 來存取。
...
#### SQL 或 NoSQL
 ...
 [來源：從 RDBMS 轉換到 NoSQL](https://www.infoq.com/articles/Transition-RDBMS-NoSQL/)
...
快取可以在客戶端\(作業系統或瀏覽器\)、[伺服器端](readme-zh-tw.md#反向代理伺服器) 或不同的緩存層等。
...
[反向代理](readme-zh-tw.md#反向代理網站伺服器) 以及像是 [Varnish](https://www.varnish-cache.org/) 等的快取服務可以提供靜態和動態內容。網站伺服器也可以快取使用者請求，返回結果，而不需要真正的處理這些請求。
...
**快取模式**
 ...
 [資料來源：從快取到記憶體資料網格](http://www.slideshare.net/tmatyashovsky/from-cache-to-in-memory-data-grid-introduction-to-hazelcast)
...
**寫入模式**
 ...
 [資料來源：可獲展性、可用性、穩定性與模式](http://www.slideshare.net/jboner/scalability-availability-stability-patterns/)
...
**更新式快取**
 ...
 [來源：從快取到記憶體資料網格技術](http://www.slideshare.net/tmatyashovsky/from-cache-to-in-memory-data-grid-introduction-to-hazelcast)
...
* \[維基百科\]\([https://en.wikipedia.org/wiki/Cache\_\(computing](https://en.wikipedia.org/wiki/Cache_%28computing)\)\)

### 非同步機制

 ![](http://i.imgur.com/54GYsSx.png)  
 [資料來源：可縮放性系統架構介紹](http://lethain.com/introduction-to-architecting-systems-for-scale/#platform_layer)
...
### 通訊
 ...
 [來源：OSI 七層模型](http://www.escotal.com/osilayer.html)
...
#### 傳輸控制通訊協定\(TCP\)
 ...
 [來源：如何開發多人遊戲](http://www.wildbunny.co.uk/blog/2012/10/09/how-to-make-a-multi-player-game-part-1/)
...
* \[確認訊息\]\([https://en.wikipedia.org/wiki/Acknowledgement\_\(data\_networks](https://en.wikipedia.org/wiki/Acknowledgement_%28data_networks)\)\) 和自動重傳

如果發送端沒有收到正確的回應，會重新發送資料，如果有多次的逾期時，連線就會斷開。TCP 實作了 \[流量控制\]\([https://en.wikipedia.org/wiki/Flow\_control\_\(data](https://en.wikipedia.org/wiki/Flow_control_%28data)\)\) 和 [阻塞控制](https://en.wikipedia.org/wiki/Network_congestion#Congestion_control)，這些機制會導致延遲，而且通常傳輸的效率會比 UDP 來得低。
...
#### 使用者資料流通訊協定 \(UDP\)
 ...
 [資料來源：如何製作多人遊戲](http://www.wildbunny.co.uk/blog/2012/10/09/how-to-make-a-multi-player-game-part-1/)
...
#### 遠端程式呼叫 \(RPC\)
 ...
 [資料來源：破解系統設計面試](http://www.puncsky.com/blog/2016-02-13-crack-the-system-design-interview)
...
| 刪除一個物品 | **POST** /removeItem{"itemid": "456"} | **DELETE** /items/456 |
 ...
 [資料來源：你真的知道為什麼你更喜歡 REST 而不是 RPC 嗎？](https://apihandyman.io/do-you-really-know-why-you-prefer-rest-over-rpc/)
...
這一章節需要更多的貢獻，一起[加入](readme-zh-tw.md#如何貢獻)吧！
...
| 貢獻更多系統設計問題 | [Contribute](readme-zh-tw.md#如何貢獻) |
...
> 底下是關於真實世界的系統架構是如何設計的文章
 ...
 [資料來源：可擴展式的 Twitter 時間軸設計](https://www.infoq.com/presentations/Twitter-Timeline-Scalability)
...
|  | 貢獻更多架構 | [Contribute](readme-zh-tw.md#如何貢獻) |
...
有興趣增加一些內容，或幫忙完善某些部分嗎？ [來貢獻吧](readme-zh-tw.md#如何貢獻)!

* 使用 MapReduce 進行分散式運算
* 一致性的 hashing
* 直接記憶體存取
* [貢獻](readme-zh-tw.md#如何貢獻)
...
_我已開放原始碼授權的方式提供你在此儲存庫中的程式碼和資源。因為這是我個人的儲存庫，所以你所以所收到的使用許可是來自於我，並非我的雇主\(Facebook\)_
